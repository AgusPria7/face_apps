...
class _SelectionModalState extends State<SelectionModal> {
  ...
  void initState() {
    super.initState();
    widget.values.forEach((itemValue) {
      widget.dataSource.forEach((item) {
        if (itemValue == item[widget.valueField]) {
          var newItem = {
                  ...
                  ButtonTheme(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                          ...
                          onPrimary: widget.saveButtonTextColor ??
    ...
    selectedValues.forEach((item) {
      ...
      selectedOptions.add(Chip(
        ...
        onDeleted: () {
          ...
          _data.removeWhere((it) => it['value'] == existingItem['value']);
          setState(() {});
        },
      ));
    });
      ...
      options.add(ListTile(
          ...
          onTap: () {
            ...
            if (item['checked']) {
              ...
              _data.removeWhere((it) => it['value'] == item['value']);
            }
